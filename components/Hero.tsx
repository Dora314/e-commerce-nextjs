...
export default function Hero() {
  return (
    <section data-testid="hero-section" className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
          ...
          <div className="text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Link href="/categories">
                <Button size="lg" variant="outline" className="border-white text-white bg-black-500 hover:bg-white hover:text-slate-900 px-8">
                  Browse Categories
                </Button>
              </Link>
            </div>
